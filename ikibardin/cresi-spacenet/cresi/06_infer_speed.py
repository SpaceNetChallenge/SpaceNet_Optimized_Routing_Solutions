...
def add_travel_time_img(image_name, pickle_protocol, graph_dir, mask_dir, conv_dict, graph_dir_out,
...
def process_img(image_name, path_images, graph_speed_dir, graph_speed_plots_dir, figsize, default_node_size,
                plot_width_key, plot_width_mult, node_color, edge_color, verbose):
...
def main():
    ...
    add_travel_time_dir(graph_dir, mask_dir, conv_dict, graph_speed_dir,
                        ...
                        save_shapefiles=False,  # save_shapefiles,  FIXME
                        verbose=verbose)
    ...
    if N_plots > 0:
        ...
        imfiles_args = [[image_name, path_images, graph_speed_dir, graph_speed_plots_dir, figsize, default_node_size,
        plot_width_key, plot_width_mult, node_color, edge_color, verbose] for image_name in
                        image_names]
