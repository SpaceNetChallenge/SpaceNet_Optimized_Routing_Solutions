"""Credits to lukemelas/EfficientNet-PyTorch"""
...
model_urls = {
    'efficientnet_b0': 'http://storage.googleapis.com/public-models/efficientnet-b0-08094119.pth',
    'efficientnet_b1': 'http://storage.googleapis.com/public-models/efficientnet-b1-dbc7070a.pth',
    'efficientnet_b2': 'http://storage.googleapis.com/public-models/efficientnet-b2-27687264.pth',
    'efficientnet_b3': 'http://storage.googleapis.com/public-models/efficientnet-b3-c8376fa2.pth',
}
...
class MBConvBlock(nn.Module):
    ...
    def __init__(self, block_args, global_params):
        ...
        # Expansion phase
        inp = self._block_args.input_filters  # in channels
        oup = self._block_args.input_filters * self._block_args.expand_ratio  # out channels
...
# @scored(size=380)
def efficientnet_b4(progress=True, **kwargs):
...
# @scored(size=456)
def efficientnet_b5(progress=True, **kwargs):
...
# @scored(size=528)
def efficientnet_b6(progress=True, **kwargs):
...
# @scored(size=600)
def efficientnet_b7(progress=True, **kwargs):
