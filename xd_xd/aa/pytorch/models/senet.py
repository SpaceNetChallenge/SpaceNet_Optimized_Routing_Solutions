...
# print('seresnet50')
# m = SeResnet50_upsample(1)
# res = m(torch.zeros((1, 3, 512 + 128, 512 + 128)))

# res = m.encoder_stages[0](torch.zeros((1, 3, 512, 512)))
# print(res.size())
# res = m.encoder_stages[1](res)
# print(res.size())
# res = m.encoder_stages[2](res)
# print(res.size())
# res = m.encoder_stages[3](res)
# print(res.size())
# res = m.encoder_stages[4](res)
# print(res.size())
# 
# print('seresnext50_32x4d')
# m = SeResnext50_32x4d_upsample(1)
# res = m.encoder_stages[0](torch.zeros((1, 3, 512, 512)))
# print(res.size())
# res = m.encoder_stages[1](res)
# print(res.size())
...
# print(res.size())
# 
# print('seresnext101_32x4d')
# m = SeResnext101_32x4d_upsample(1)
# res = m.encoder_stages[0](torch.zeros((1, 3, 512, 512)))
# print(res.size())
# res = m.encoder_stages[1](res)
# print(res.size())
