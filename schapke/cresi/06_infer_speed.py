...
import f08a_plot_graph_plus_im
...
###############################################################################
def load_speed_conversion_dict_binned(csv_loc, speed_increment=5, num_classes=10):
    '''Load speed to burn_val conversion dataframe 
    and create conversion dictionary.
...
def test():
    ...
    # get conversion dict
    df_speed, dic_speed = load_speed_conversion_dict_binned(conversion_csv_loc, num_classes=config)
