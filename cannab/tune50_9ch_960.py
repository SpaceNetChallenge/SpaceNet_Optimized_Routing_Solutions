...
class TrainData(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if (('Moscow' not in img_id) and ('Mumbai' not in img_id) and (random.random() > 0.8)) or (random.random() > 0.95):
            img = img[::-1, ...]
            img2 = img2[::-1, ...]
            img3 = img3[::-1, ...]
            msk0 = msk0[::-1, ...]
...
if __name__ == '__main__':
    ...
    snapshot_name = 'res50_9ch_960_{}_0'.format(seed)
    ...
    scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[4, 8, 10], gamma=0.5)
