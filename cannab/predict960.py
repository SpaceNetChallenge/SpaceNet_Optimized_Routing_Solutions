...
test_png = '/wdata/test_png_960'
test_png2 = '/wdata/test_png_5_3_0_960'
test_png3 = '/wdata/test_png_pan_6_7_960'

models_folder = '/wdata/weights'
output_folder = '/wdata/test_pred_960'
...
if __name__ == '__main__':
    ...
    for fold in [3, 4]:
        ...
        snap_to_load = 'dpn92_9ch_{}_0_best'.format(fold)
    ...
    for fold in [5, 6]:
        ...
        snap_to_load = 'res50_9ch_960_{}_0_best'.format(fold)
        checkpoint = torch.load(path.join(models_folder, snap_to_load), map_location='cpu')
        loaded_dict = checkpoint['state_dict']
        sd = model.state_dict()
        for k in model.state_dict():
    ...
    for fold in [1, 2]:
        ...
        snap_to_load = 'res34_9ch_960_{}_0_best'.format(fold)
        checkpoint = torch.load(path.join(models_folder, snap_to_load), map_location='cpu')
        loaded_dict = checkpoint['state_dict']
        sd = model.state_dict()
        for k in model.state_dict():
